## [Проект 1. Восстановление золота из руды](gold-recovery.ipynb)
...
Входные данные: это сырые данные с параметрами добычи и очистки.
...
- *sMAPE* = 8.41% - для таргета "эффективность обогащения чернового концентрата";
- *sMAPE* = 9.59% - для таргета "эффективность обогащения финального концентрата";
- *final_sMAPE* = 9.29%.
