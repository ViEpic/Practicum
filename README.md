...
| --- | ---------------- | -------- | ----------------------- |
| 1.  | [Восстановление золота из руды]([sale-of-apartments.ipynb](https://github.com/VictorAndreevichK/Practicum/tree/ef12cc97a6ae96d71ad24b7be011ddffc32a8b48/Gold%20recovery)) | Прогноз коэффициента восстановления золота из золотосодержащей руды с целью не запускать промышленное предприятие с убыточными характеристиками | *PYTHON: matplotlib, numpy, pandas, seaborn, sklearn, исследовательский анализ данных* |
...
| 8. | [Определение возраста покупателей](determining-the-age-of-buyers--computer-vision.ipynb) | Определение по фотографии приблизительного возраста человека для сетевого супермаркета | *PYTHON: matplotlib, pandas, tensorflow* |
Gold recovery
